...
```
```{r}
a <- read_tsv("/Volumes/lab_kingsley/ambenj/myosin_dups/analysis/assemblies/figure/combined_annotations_wFragments.txt") %>% 
...
webshot2::webshot(
  "temp.html", 
  "/Volumes/lab_kingsley/ambenj/myosin_dups/analysis/assemblies/figure/cluster_plot_wFragments.pdf", 
