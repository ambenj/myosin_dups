...
liftoff -g $SOURCE_GFF_all -o ${BASE}.NCBI.MYHrevised.gff -u ${BASE}.NCBI.MYHrevised.unlifted.gff -dir ${BASE}_liftoff.NCBI.MYHrevised_intermediate_files -copies -sc 0.98 $TARGET $SOURCE_FA
...
liftoff -g $SOURCE_GFF_chrXIX -o ${BASE}.NCBI.MYHrevised_chrXIX.gff -u ${BASE}.NCBI.MYHrevised_chrXIX.unlifted.gff -dir ${BASE}_liftoff.NCBI.MYHrevised_chrXIX_intermediate_files -copies -sc 0.98 $TARGET $SOURCE_FA
...
liftoff -g $SOURCE_GFF_chrY -o ${BASE}.NCBI.MYHrevised_chrY.gff -u ${BASE}.NCBI.MYHrevised_chrY.unlifted.gff -dir ${BASE}_liftoff.NCBI.MYHrevised_chrY_intermediate_files -copies -sc 0.98 $TARGET $SOURCE_FA
