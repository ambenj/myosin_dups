...
mk_CH_two_sided <- mk.test(pull(filter(roi_cov, pop == "CH", desc=="MYH3C3"), chrXIX_norm_depth), alternative = "two.sided" )
mk_CH_two_sided
```
```{r}
...
mk_SC_two_sided <- mk.test(pull(filter(roi_cov, pop == "SC", desc=="MYH3C3"), chrXIX_norm_depth), alternative = "two.sided")
mk_SC_two_sided
```
```{r}
...
mk_LB_two_sided <- mk.test(pull(filter(roi_cov, pop == "LB", desc=="MYH3C3"), chrXIX_norm_depth), alternative = "two.sided" )
mk_LB_two_sided
```
```{r}
